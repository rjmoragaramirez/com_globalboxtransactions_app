...
import 'package:com_globalboxtransactions_app/widgets/beneficiariesitemdetailhorizontal.dart';
import 'package:flutter/material.dart';
import 'package:flutter/rendering.dart';
import 'package:graphql_flutter/graphql_flutter.dart';

import 'beneficiariesitemdetail.dart';

class FavoriteBeneficiaries extends StatefulWidget {
  final ValueNotifier<GraphQLClient> clientVN;

  const FavoriteBeneficiaries({required this.clientVN});

  @override
  _FavoriteBeneficiariesState createState() => _FavoriteBeneficiariesState();
}

class _FavoriteBeneficiariesState extends State<FavoriteBeneficiaries> {
  @override
        ...
        if(code == 200){
          ...
          return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index){
                ...
                return BeneficiariesItemDetailHorizontal(beneficiary: beneficiary);
              }
          );
        } else {
          return Container();
